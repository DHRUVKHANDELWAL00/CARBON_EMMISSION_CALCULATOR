$(document).ready(function() {
	...
	$("#calculate-btn").on("click", function() {
		var calculateAndDisplayScore = function() {
			...
			// get input values
      var electricInput = document.getElementById("elec").value;
      var gasInput = document.getElementById("gas").value;
      var oilInput = document.getElementById("machine").value;
      var carInput = document.getElementById("vefeul").value;

      var transportInput = document.getElementById("transexp").value;
      var inventoryInput = document.getElementById("invenexp").value;
      var servicesInput = document.getElementById("servicesexp").value;
